...
export default {
  ...
  setDataDetails: (goods_id, name, amount_type, amount, tips, cover_image, carousel_images, details_images, service_description_images, status, type, sort, sale_num, sale_increase, subs) => request.post('/shop-management/product-management/set-data-details', { goods_id, name, amount_type, amount, tips, cover_image, carousel_images, details_images, service_description_images, status, type, sort, sale_num, sale_increase, subs }, { removeEmpty: false }), // 存储商品信息
}
