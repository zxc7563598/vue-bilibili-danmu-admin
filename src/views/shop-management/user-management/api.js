...
export default {
  ...
  getUserPointRecords: user_id => request.post('/shop-management/user-management/get-user-point-records', { user_id }), // 获取用户积分变更记录
  getUserCoinRecords: user_id => request.post('/shop-management/user-management/get-user-coin-records', { user_id }), // 获取用户硬币变更记录
